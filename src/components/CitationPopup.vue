<template>
  ...
  >
    <div
      ...
      class="w-3/5 min-h-30vh max-h-80vh overflow-y-auto m-auto bg-white p-8 shadow-card rounded-1rem"
    >
      <header class="flex justify-between max-h-80vh mb-10">
        <h2 class="w-4/6 text-24R font-bold text-justify">
      ...
      <div>
        <table class="citation-table">
          ...
          <tr v-for="cite in citationObj.citation" :key="'cite' + cite">
            ...
            <td class="pl-10 text-2xl font-normal font-inter text-justify">
              {{ cite }}
            </td>
          </tr>
        </table>
